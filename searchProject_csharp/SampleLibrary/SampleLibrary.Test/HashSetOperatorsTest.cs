...
public class HashSetOperatOrsTest
{
    ...
    public void TestAnd1(){
        ...
        Assert.Equal(_hashSetOperators.And(_sets1), expected);
    }

    [Fact]
    public void TestAnd2(){
        var expected = new HashSet<int>();
        Assert.Equal(_hashSetOperators.And(_sets2), expected);
    }
    ...
    public void TestOr1(){
        ...
        Assert.Equal(_hashSetOperators.Or(_sets1), expected);
    }
    ...
    public void TestOr2(){
        ...
        Assert.Equal(_hashSetOperators.Or(_sets2), expected);
    }
    ...
    public void TestSub1(){
        ...
        Assert.Equal(_hashSetOperators.Sub(_set1,_set2), expected);
    }

    [Fact]
    public void TestSub2(){
        Assert.Equal(_hashSetOperators.Sub(_set1,_set4), _set1);
    }
